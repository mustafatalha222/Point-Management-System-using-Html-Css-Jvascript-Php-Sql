...
$CT0 = mysqli_query($conn,"CREATE TABLE Customer( user_name varchar(40), C_ID varchar(10),c_address VARCHAR(50) ,C_DOB VARCHAR(30),Gender VARCHAR(5),bus_id VARCHAR(10),bill_id VARCHAR(30),C_contactno VARCHAR(11) )");
...
$CT7 = mysqli_query($conn,"CREATE table users(user_name varchar(30),user_pass varchar(30),user_email varchar(30),age int(10))");
...
$alter1 = mysqli_query($conn,"Alter table Customer add constraint fkey1 FOREIGN KEY(bus_id) REFERENCES Bus(bus_id)");
$alter2 = mysqli_query($conn,"Alter table Customer add constraint fkey2 FOREIGN KEY(bill_id) REFERENCES Bill(bill_id)");
